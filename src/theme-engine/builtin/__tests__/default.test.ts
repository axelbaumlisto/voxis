// src/theme-engine/builtin/__tests__/default.test.ts
...
describe("default theme", () => {
  ...
  it("mounts, renders bars with blue gradient, unmounts cleanly", () => {
    ...
    expect(bar.style.background).toContain("rgb(30, 136, 229)");
    inst.unmount();

// src/theme-engine/builtin/__tests__/neon.test.ts
import { describe, it, expect } from "vitest";
import * as theme from "../neon";
...
describe("neon theme", () => {
  ...
  it("mounts, renders bars with cyan gradient, unmounts cleanly", () => {
    ...
    expect(bar.style.background).toContain("rgb(0, 255, 255)");
    inst.unmount();

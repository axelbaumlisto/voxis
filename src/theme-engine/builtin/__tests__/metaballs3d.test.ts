// src/theme-engine/builtin/__tests__/metaballs3d.test.ts
//
// Unit test for the metaballs3d (WebGL raymarched) theme. This runs in jsdom,
...
//     WebGL e2e test: e2e/metaballs3d-pulse.spec.ts.
import { describe, it, expect, beforeEach, afterEach, vi } from "vitest";
import * as theme from "../metaballs3d";
...
describe("metaballs3d theme (jsdom — no WebGL)", () => {
  ...
  it("bails gracefully when WebGL is unavailable (jsdom getContext → null)", () => {
    ...
    expect(warnedMsg).toContain("metaballs3d");

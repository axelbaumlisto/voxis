...
function resampleToBars(bins, count = BAR_COUNT) {
  if (bins.length === 0)
...
var pillIdCounter = 0;
function generateScopedCSS(scopeClass, palette) {
...
function createPillRenderer(container, opts) {
